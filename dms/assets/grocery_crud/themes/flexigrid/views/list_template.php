...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="sDiv quickSearchBox" id='quickSearchBox'>
		<div class="sDiv2">
			...
			<select name="search_field" id="search_field" class="gc_search_colums_select">
		...
		<div class="pDiv2">
			<div class="pGroup">
				<span class="pcontrol">
					...
					<select name="per_page" id='per_page' class="per_page gc_search_colums_select">
			...
			<div class="pGroup">
				<div class="pFirst first-button btn">
				<i class="fas fa-angle-double-left"></i>
				</div>
				<div class="pPrev prev-button btn">
			...
			<div class="pGroup">
				<div class="pNext next-button btn" >
				<i class="fas fa-angle-double-right"></i>
				</div>
				<div class="pLast last-button btn">
			...
			<div class="pGroup">
				<div class="pReload btn ajax_refresh_and_loading" id='ajax_refresh_and_loading'>
			...
			<div class="pGroup">
				<span class="pPageStat badge badge-secondary">
